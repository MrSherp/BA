...
template < typename RealType, typename VectorNd, typename OperatorType, typename ProjectorOntoC, typename ProjectorOntoK >
void ChambollePockAlgorithm2 ( VectorNd& PrimalSolution, VectorNd& DualSolution, const OperatorType& K, ProjectorOntoC& ResolventOfG, ProjectorOntoK& ResolventOfH, const RealType gamma, RealType& tau, RealType& sigma, const int maxIter, const RealType StopEpsilon, int& enditer, RealType& endepsilon ) {
  VectorNd xBar ( PrimalSolution );
  VectorNd oldPrimalSolution ( PrimalSolution );
  VectorNd adjointOfDual ( PrimalSolution );
  VectorNd gradientOfXBar ( DualSolution );
...
void applyChambollePockAccelerated ( VectorNd& PrimalSolution, VectorNd& DualSolution, const VectorNd& Disparity, const int N, const OpType& Fd, const boost::property_tree::ptree& Pt ) {
